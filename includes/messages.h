...
default value "
# define WRONG_JULIA_C "[Warning] At least one of the passed parameters for C \
...
# define WRONG_COLOR_SET "[Warning] Color set not a valid input - set to default \
value "
...
# define MAX_ZOOM_OUT "Zooming further out not possible -> reached lowest \
zoom value"
